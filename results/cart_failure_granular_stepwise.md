...
| Metric | Value | Notes |
|--------|-------|-------|
| Call error rate | 0.00 (0/12) | invalid = unknown name or MCP isError |
| Steps to evidence | 12 | marker `oteldemo.CartService/EmptyCart` + `can't access cart storage` |
| Context bloat ratio | 123.67 | 9894 response tokens / 80 min |
