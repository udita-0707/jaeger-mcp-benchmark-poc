...
| Metric | Value | Notes |
|--------|-------|-------|
| Call error rate | 0.00 (0/8) | invalid = unknown name or MCP isError |
| Steps to evidence | 8 | marker `oteldemo.CartService/EmptyCart` + `can't access cart storage` |
| Context bloat ratio | 118.09 | 9447 response tokens / 80 min |
